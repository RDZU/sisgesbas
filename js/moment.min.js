...
var monthsShort = 'led_úno_bre_dub_kve_cvn_cvc_srp_zár_ríj_lis_pro'.split('_');
function plural$1(n) {
...
var monthsSubjective = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrzesnia_pazdziernika_listopada_grudnia'.split('_');
function plural$3(n) {
...
hooks.defineLocale('tr', {
    ...
    dayOfMonthOrdinalParse: /\d{1,2}'(inci|nci|üncü|nci|uncu|inci)/,
    ordinal : function (number) {
        if (number === 0) {  // special case for zero
            return number + '\'inci';
        }
